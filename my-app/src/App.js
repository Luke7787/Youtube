...
import symfuhny from './images/symfuhny.jpeg';
  ...
  return (
    ...
    <div className="HomePage">
      ...
      <aside className="LeftSideBar">
        ...
        {/* Show more Section */}
        {/* When the button is pressed the button becomes hidden but shows the remainding channel */}
        {!showChannels && (<button className="LeftSideBarButton" onClick={() => setShowChannels(true)}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            height="24"
        ...
        {/* State condition that show remainding channel */}
        {showChannels && (<>
        {/* Pirate Software */}
        <button className="LeftSideBarButton">
          <img src={pirate} alt="Pirate Software" className="SubscriptionIcon" />
          <span className="SubscriptionText">Pirate Software</span>
        ...
        {/* Science Channel */}
        <button className="LeftSideBarButton">
          <img src={science} alt="Science Channel" className="SubscriptionIcon" />
          <span className="SubscriptionText">Science Channel</span>
        ...
        {/* Symfuhny */}
        <button className="LeftSideBarButton">
          <img src={symfuhny} alt="Symfuhny" className="SubscriptionIcon" />
          <span className="SubscriptionText">Symfuhny</span>
      ...
      {/* Youtube's Fashion & Beauty Icon SVG */}
      <button className="LeftSideBarButton">
          <svg
            xmlns="http://www.w3.org/2000/svg" 
            fill="currentColor" 
      ...
      <button className="LeftSideBarButton">
        ...
        <button className="LeftSideBarButton">
            <svg
              ...
              className="IconStyle" 
            >
              <path fill="#FF0033" d="M21,17H3c-0.55,0-1-0.45-1-1V6c0-0.55,0.45-1,1-1h18c0.55,0,1,0.45,1,1v10C22,16.55,21.55,17,21,17z    M19,19.2v-0.9c0-0.17-0.13-0.3-0.3-0.3H5.3C5.13,18,5,18.13,5,18.3v0.9c0,0.17,0.13,0.3,0.3,0.3h13.4C18.87,19.5,19,19.37,19,19.2   z"></path>
              <polygon fill="#FFFFFF" points="10,14 15,11 10,8  "></polygon>
            </svg>
            YouTube TV
          </button>
        ...
        <button className="LeftSideBarButton">
            <svg
              ...
              className="IconStyle" 
            >
              <circle id="XMLID_4814__yt167" fill="#FF0033" cx="12" cy="12" r="11"></circle>
      ...
      <main className="MainContent">
        ...
        <div className="videos">
          ...
          <div className="videoElement">
            <div class="youtubeProfile"></div>
            <div className="videoTitle">video 2</div>
            <div className="channelSection">
            <div className="channelName">Channel Name</div>
            <svg
              xmlns="http://www.w3.org/2000/svg" 
          ...
          <div className="videoElement">
            <div class="youtubeProfile"></div>
            <div className="videoTitle">video 3</div>
            <div className="channelSection">
            <div className="channelName">Channel Name</div>
            <svg
              xmlns="http://www.w3.org/2000/svg" 
          ...
          <div className="videoElement">
            <div class="youtubeProfile"></div>
            <div className="videoTitle">video 4</div>
            <div className="channelSection">
            <div className="channelName">Channel Name</div>
            <svg
              xmlns="http://www.w3.org/2000/svg" 
          ...
          <div className="videoElement">
            <div class="youtubeProfile"></div>
            <div className="videoTitle">video 5</div>
            <div className="channelSection">
            <div className="channelName">Channel Name</div>
            <svg
              xmlns="http://www.w3.org/2000/svg" 
          ...
          <div className="videoElement">
            <div class="youtubeProfile"></div>
            <div className="videoTitle">video 6</div>
            <div className="channelSection">
            <div className="channelName">Channel Name</div>
            <svg
              xmlns="http://www.w3.org/2000/svg" 
